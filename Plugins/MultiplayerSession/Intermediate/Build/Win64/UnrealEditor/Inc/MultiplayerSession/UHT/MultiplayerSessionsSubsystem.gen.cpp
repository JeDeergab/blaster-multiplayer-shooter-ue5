...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_MultiplayerSession_MultiplayerOnCreateSessionComplete__DelegateSignature_Statics::Function_MetaDataParams[] = {
		...
		{ "ToolTip", "Declaring our own custom delegates from the menu class to bind callbacks to" },
	};
#endif
...
void FMultiplayerOnStartSessionComplete_DelegateWrapper(const FMulticastScriptDelegate& MultiplayerOnStartSessionComplete, bool bWasSuccessful)
{
	...
	struct Z_CompiledInDeferFile_FID_Users_JohnE_OneDrive_Documents_Unreal_Projects_Blaster_Plugins_MultiplayerSession_Source_MultiplayerSession_Public_MultiplayerSessionsSubsystem_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_JohnE_OneDrive_Documents_Unreal_Projects_Blaster_Plugins_MultiplayerSession_Source_MultiplayerSession_Public_MultiplayerSessionsSubsystem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMultiplayerSessionsSubsystem, UMultiplayerSessionsSubsystem::StaticClass, TEXT("UMultiplayerSessionsSubsystem"), &Z_Registration_Info_UClass_UMultiplayerSessionsSubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMultiplayerSessionsSubsystem), 2676551848U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_JohnE_OneDrive_Documents_Unreal_Projects_Blaster_Plugins_MultiplayerSession_Source_MultiplayerSession_Public_MultiplayerSessionsSubsystem_h_3503822944(TEXT("/Script/MultiplayerSession"),
		Z_CompiledInDeferFile_FID_Users_JohnE_OneDrive_Documents_Unreal_Projects_Blaster_Plugins_MultiplayerSession_Source_MultiplayerSession_Public_MultiplayerSessionsSubsystem_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_JohnE_OneDrive_Documents_Unreal_Projects_Blaster_Plugins_MultiplayerSession_Source_MultiplayerSession_Public_MultiplayerSessionsSubsystem_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
