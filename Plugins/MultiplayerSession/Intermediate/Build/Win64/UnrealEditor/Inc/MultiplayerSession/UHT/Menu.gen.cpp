...
// End Cross Module References
	...
	DEFINE_FUNCTION(UMenu::execOnStartSessions)
	{
		P_GET_UBOOL(Z_Param_bWasSuccessful);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->OnStartSessions(Z_Param_bWasSuccessful);
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(UMenu::execOnDestroySessions)
	{
		P_GET_UBOOL(Z_Param_bWasSuccessful);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->OnDestroySessions(Z_Param_bWasSuccessful);
		P_NATIVE_END;
	}
	...
	void UMenu::StaticRegisterNativesUMenu()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "OnDestroySessions", &UMenu::execOnDestroySessions },
			{ "OnStartSessions", &UMenu::execOnStartSessions },
		};
	...
	struct Z_Construct_UFunction_UMenu_OnDestroySessions_Statics
	{
		struct Menu_eventOnDestroySessions_Parms
		{
			bool bWasSuccessful;
		};
	...
	void Z_Construct_UFunction_UMenu_OnDestroySessions_Statics::NewProp_bWasSuccessful_SetBit(void* Obj)
	{
		((Menu_eventOnDestroySessions_Parms*)Obj)->bWasSuccessful = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMenu_OnDestroySessions_Statics::NewProp_bWasSuccessful = { "bWasSuccessful", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(Menu_eventOnDestroySessions_Parms), &Z_Construct_UFunction_UMenu_OnDestroySessions_Statics::NewProp_bWasSuccessful_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UMenu_OnDestroySessions_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UMenu_OnDestroySessions_Statics::NewProp_bWasSuccessful,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UMenu_OnDestroySessions_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/Menu.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMenu_OnDestroySessions_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMenu, nullptr, "OnDestroySessions", nullptr, nullptr, sizeof(Z_Construct_UFunction_UMenu_OnDestroySessions_Statics::Menu_eventOnDestroySessions_Parms), Z_Construct_UFunction_UMenu_OnDestroySessions_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMenu_OnDestroySessions_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00080401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UMenu_OnDestroySessions_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UMenu_OnDestroySessions_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UMenu_OnDestroySessions()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UMenu_OnDestroySessions_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_UMenu_OnStartSessions_Statics
	{
		struct Menu_eventOnStartSessions_Parms
		{
			bool bWasSuccessful;
		};
		static void NewProp_bWasSuccessful_SetBit(void* Obj);
	...
	void Z_Construct_UFunction_UMenu_OnStartSessions_Statics::NewProp_bWasSuccessful_SetBit(void* Obj)
	{
		((Menu_eventOnStartSessions_Parms*)Obj)->bWasSuccessful = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMenu_OnStartSessions_Statics::NewProp_bWasSuccessful = { "bWasSuccessful", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(Menu_eventOnStartSessions_Parms), &Z_Construct_UFunction_UMenu_OnStartSessions_Statics::NewProp_bWasSuccessful_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UMenu_OnStartSessions_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UMenu_OnStartSessions_Statics::NewProp_bWasSuccessful,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UMenu_OnStartSessions_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/Menu.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMenu_OnStartSessions_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMenu, nullptr, "OnStartSessions", nullptr, nullptr, sizeof(Z_Construct_UFunction_UMenu_OnStartSessions_Statics::Menu_eventOnStartSessions_Parms), Z_Construct_UFunction_UMenu_OnStartSessions_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMenu_OnStartSessions_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00080401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UMenu_OnStartSessions_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UMenu_OnStartSessions_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UMenu_OnStartSessions()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UMenu_OnStartSessions_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#endif
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_UserWidgetInstance_MetaData[];
#endif
		static const UECodeGen_Private::FObjectPropertyParams NewProp_UserWidgetInstance;
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMenu_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UMenu_MenuSetup, "MenuSetup" }, // 3674829644
		{ &Z_Construct_UFunction_UMenu_OnCreateSession, "OnCreateSession" }, // 2305451722
		{ &Z_Construct_UFunction_UMenu_OnDestroySessions, "OnDestroySessions" }, // 5286156
		{ &Z_Construct_UFunction_UMenu_OnStartSessions, "OnStartSessions" }, // 617619274
	};
#if WITH_METADATA
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMenu_Statics::NewProp_UserWidgetInstance_MetaData[] = {
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/Menu.h" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UMenu_Statics::NewProp_UserWidgetInstance = { "UserWidgetInstance", nullptr, (EPropertyFlags)0x0010000000080008, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UMenu, UserWidgetInstance), Z_Construct_UClass_UUserWidget_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UMenu_Statics::NewProp_UserWidgetInstance_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMenu_Statics::NewProp_UserWidgetInstance_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UMenu_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UMenu_Statics::NewProp_UserWidgetInstance,
	...
	UMenu::~UMenu() {}
	struct Z_CompiledInDeferFile_FID_Users_JohnE_OneDrive_Documents_Unreal_Projects_Blaster_Plugins_MultiplayerSession_Source_MultiplayerSession_Public_Menu_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_JohnE_OneDrive_Documents_Unreal_Projects_Blaster_Plugins_MultiplayerSession_Source_MultiplayerSession_Public_Menu_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMenu, UMenu::StaticClass, TEXT("UMenu"), &Z_Registration_Info_UClass_UMenu, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMenu), 3098602000U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_JohnE_OneDrive_Documents_Unreal_Projects_Blaster_Plugins_MultiplayerSession_Source_MultiplayerSession_Public_Menu_h_4005183015(TEXT("/Script/MultiplayerSession"),
		Z_CompiledInDeferFile_FID_Users_JohnE_OneDrive_Documents_Unreal_Projects_Blaster_Plugins_MultiplayerSession_Source_MultiplayerSession_Public_Menu_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_JohnE_OneDrive_Documents_Unreal_Projects_Blaster_Plugins_MultiplayerSession_Source_MultiplayerSession_Public_Menu_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
